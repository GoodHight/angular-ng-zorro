...
/**
 * Remove a child component from this component's index of children, and the
...
vjs.MenuButton.prototype.createMenu = function(){
  ...
  // Add a title index item to the top
...
/**
 * Create the index of menu items. Specific to each subclass.
 */
...
// Can't turn off index display that we turned on with focus, because index would go away.
 ...
 * The user agent is maintaining a index of which cues are active, and events are being fired accordingly.
  ...
  if (this.cues_.length > 0) {
    ...
    if (this.prevChange === undefined || time < this.prevChange || this.nextChange <= time) {
      ...
      if (time >= this.nextChange || this.nextChange === undefined) { // NextChange should happen
        // Forwards, so start at the resume of the first active cue and loop forward
        i = (this.firstActiveIndex !== undefined) ? this.firstActiveIndex : 0;
      } else {
        // Backwards, so start at the resume of the last active cue and loop backward
        reverse = true;
