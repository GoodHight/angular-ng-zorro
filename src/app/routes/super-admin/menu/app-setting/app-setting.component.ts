...
export class AppSettingComponent implements OnInit {
    ...
    * */
    public getListDatas() {
        this.http.get(this.url + '/app-template-menu/enterpriseId/' + this.tokenService.get().enterprisesInfo.enterprisesId)
            .subscribe((res: any) => {
                if (res.code === 1) {
    ...
    * */
    submit() {
        ...
        this.http.post(this.url + '/app-role/add-auth/' + this.guid, selectedMenus)
            .subscribe((res: any) => {
                if (res.code === 1) {
