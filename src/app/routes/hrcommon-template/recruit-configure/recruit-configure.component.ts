...
@Component({
  selector: 'recruit-configure',
  templateUrl: './recruit-configure.component.html',
  styleUrls: ['./recruit-configure.component.css']
})
export class RecruitConfigureComponent implements OnInit {
