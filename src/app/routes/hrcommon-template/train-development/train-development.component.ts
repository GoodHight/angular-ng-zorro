...
@Component({
  selector: 'train-development',
  templateUrl: './train-development.component.html',
  styleUrls: ['./train-development.component.css']
})
export class TrainDevelopmentComponent implements OnInit {
